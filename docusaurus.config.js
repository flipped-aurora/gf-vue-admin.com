module.exports = {
    title: 'Gf-Vue-Admin',
    tagline: '使用goframe+vue进行极速开发的全栈后台管理系统',
    url: 'https://gf-vue-admin.com',
    baseUrl: '/',
    onBrokenLinks: 'throw',
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [{
                ...
                {
                    href: 'http://demo.gf-vue-admin.com/',
                    label: '在线体验',
                    position: 'right',
                },
                {
                    href: 'https://github.com/flipped-aurora/gf-vue-admin',
                    label: 'GitHub',
                    position: 'right',
                },
                {
                    href: 'https://gitee.com/flipped-aurora/gf-vue-admin',
                    label: 'Gitee',
                    position: 'right',
                },
                {
